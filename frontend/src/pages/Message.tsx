...
const NewsPage = () => {
  ...
  const documents = [
    { name: "19th year EOTC NACLAASSU.pdf", path: "/documents/19th year EOTC NACLAASSU.pdf" },
    { name: "2024 METSHET FOR EOTC NACLAASSU.pdf", path: "/documents/2024 METSHET FOR EOTC NACLAASSU.pdf" },
    { name: "2025 EOTC NACLAASSU LIDET.pdf", path: "/documents/2025 EOTC NACLAASSU LIDET.pdf" },
    ...
    { name: "EOTC NACLAASSU ABIY TSOME.pdf", path: "/documents/EOTC NACLAASSU ABIY TSOME.pdf" },
    { name: "EOTC NACLAASSU GEBRHER.pdf", path: "/documents/EOTC NACLAASSU GEBRHER.pdf" },
    { name: "EOTC NACLAASSU KIDIST.pdf", path: "/documents/EOTC NACLAASSU KIDIST.pdf" },
    { name: "EOTC NACLAASSU LIDET BEAL 2024.pdf", path: "/documents/EOTC NACLAASSU LIDET BEAL 2024.pdf" },
    { name: "EOTC NACLAASSU MEKURAB.pdf", path: "/documents/EOTC NACLAASSU MEKURAB.pdf" },
    { name: "EOTC NACLAASSU METSAGU.pdf", path: "/documents/EOTC NACLAASSU METSAGU.pdf" },
    { name: "EOTC NACLAASSU NEW YEAR.pdf", path: "/documents/EOTC NACLAASSU NEW YEAR.pdf" },
    { name: "EOTC NACLAASSU NICODIMUS.pdf", path: "/documents/EOTC NACLAASSU NICODIMUS.pdf" },
    { name: "EOTC NACLAASSU SIBKET BIRHAN AND NOLAWI.pdf", path: "/documents/EOTC NACLAASSU SIBKET BIRHAN AND NOLAWI.pdf" },
    { name: "EOTC NACLAASSU SPIRITUAL ETHICS 1.pdf", path: "/documents/EOTC NACLAASSU SPIRITUAL ETHICS 1.pdf" },
    { name: "EOTC NACLAASSU TSOME NINEVEH (NENEWE).pdf", path: "/documents/EOTC NACLAASSU TSOME NINEVEH (NENEWE).pdf" },
    { name: "EOTC NACLAASSU WOREHA TSIGE.pdf", path: "/documents/EOTC NACLAASSU WOREHA TSIGE.pdf" },
    { name: "POEM FOR EOTC NACLAASSU 2018.pdf", path: "/documents/POEM FOR EOTC NACLAASSU 2018.pdf" },
